...
main :: IO ()
main = putStrLn "Kardashev Scale, 1-6 are important for consideration."
    {-
    <h2>Environmental Science</h2>
    <p>
      Ecosphere, Biome, Ecosystem, Community, Population, Organism. There are various trophic levels (tertiary/secondary/primary/other) and cycles (rock/water/nitrogen/light).
    </p>
    <h2>Mars</h2>
    <p> 
    ...
    <h2>Endangered and Invasive Species</h2>
    <p> 
    ...
    <h2>Sleep Cycle</h2>
    <p>  
      Use aromatherapy; imagine you are a log in a forest; count sheep to 225 or so.
    </p>
    <h2>Workoutizer</h2>
    <p> 
    ...
    <h2>Energy</h2>
    <p>Fusion/Fission may sometime become less important than solar sources.</p>
-}
